...
[![GitHub Repo releses](https://img.shields.io/badge/GitHubRepo-LeatestReleases-6f42c1?logo=semantic-release&logoColor=white)](https://github.com/SilverTrust123/demo/archive/refs/tags/V4.0.0.zip)
...
> 最新版本 version 4.0.0 (關於本本資訊請點)[這裡](https://github.com/SilverTrust123/demo/releases/tag/V4.0.0)
...
> latest version 4.0.0 (for version detail plc check here)[here](https://github.com/SilverTrust123/demo/releases/tag/V4.0.0)
...
### 如果上面地址失靈請點這裡的URL -> 
https://github.com/SilverTrust123/demo/releases/tag/V4.0.0    
