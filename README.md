...
> 最新版本 version 3.1.2 (關於本本資訊請點)[這裡](https://github.com/SilverTrust123/demo/releases/tag/V3.1.2)
...
> latest version 3.1.2 (for version detail plc check here)[here](https://github.com/SilverTrust123/demo/releases/tag/V3.1.2)
...
### 如果上面地址失靈請點這裡的URL -> 
https://github.com/SilverTrust123/demo/releases/tag/V3.1.2    
