...
> 最新版本 version 2.0.1 (關於本本資訊請點)[這裡](https://github.com/SilverTrust123/demo/releases/tag/V2.0.1)
...
> latest version 2.0.1 (for version detail plc check here)[here](https://github.com/SilverTrust123/demo/releases/tag/V2.0.1)
