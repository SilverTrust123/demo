...
> 最新版本 version 3.0.0 (關於本本資訊請點)[這裡](https://github.com/SilverTrust123/demo/releases/tag/V3.0.0)
...
> latest version 3.0.0 (for version detail plc check here)[here](https://github.com/SilverTrust123/demo/releases/tag/V3.0.0)
